...
var f=document.WizMailer;
	...
	if(f.FromEmail.value==""){
      ...
      alert ("Please. Fill in Sender Email.");
...
<input type="button" name="Button" value="추가" onClick="javascript:addToMail();return false"; style="cursor:pointer">
			  ...
			  <tr> 
                  ...
                  <td width="87" height="24" align="center" bgcolor="#F2F2F2" class="company">Sender</td>
              ...
              <tr> 
                  ...
                  <td height="26" align="center" bgcolor="#F2F2F2" class="company">Subject</td>
              ...
              <tr> 
                  ...
                  <td align="center" bgcolor="#F2F2F2" class="company">Comment</td>
			   ...
			   <tr> 
                  ...
                  <td height="26" align="center" bgcolor="#F2F2F2" class="company">Trans.Type</td>
			  ...
			  <tr> 
                  ...
                  <td height="26" align="center" bgcolor="#F2F2F2" class="company">Attached.</td>
