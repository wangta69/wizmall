  ...
  <tr>
	...
	<form name="wizBlogForm" method="POST" action="./wizmember/<?=$cfg["skin"]["MemberSkin"]?>/BlogMemberRegisQry.php" onsubmit='return checkForm();' enctype="multipart/form-data">
        ...
        <tr> 
          ...
          <td width="362"><input type="text" name="Subject" style="width:340px;height:18px" maxlength="64"></td>
        </tr>
        <tr> 
        ...
        <tr align="center"> 
          <td height="14" colspan="2"><input type="image" src="./wizmember/<?=$cfg["skin"]["MemberSkin"]?>/blogimages/save_btn.gif" width="61" height="21">&nbsp;<img src="./wizmember/<?=$cfg["skin"]["MemberSkin"]?>/blogimages/cancel_btn.gif" width="61" height="21" onclick="javascript:history.go(-1)"; style="cursor:pointer"></td>
        </tr>
        <tr>
          <td colspan="2" height="14"></td>
        </tr></form>
