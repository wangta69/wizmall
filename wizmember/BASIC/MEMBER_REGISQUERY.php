...
mid,mpasswd,mname,mregdate,mgrantsta,mtype,mgrade,mailreceive,msmsreceive,mloginnum,mlogindate,mloginip
)
VALUES(
'$id','".$common->mksqlpwd($passwd)."','$name','".time()."','$mgrantsta','$type','$mgrade','$mailreceive','$smsreceive',0,'".time()."','".$_SERVER['REMOTE_ADDR']."'
)";	
$dbcon->_query($sqlstr);
...
values(
'$id','$nickname','$pwdhint','$pwdanswer','$gender','".$common->mksqlpwd($jumin1, "memjumin")."','".$common->mksqlpwd($jumin2, "memjumin")."','$birthdate','$birthtype','$marrdate','$marrstatus','$email','$mailreceive','$job','$scholarship','$company','$companynum','$telflag','$tel1','$tel2','$tel3','$fax','$zip1','$addressflag','$address1','$address2','$zip2','$address3','$address4','$url','$recid'
)";	
$dbcon->_query($sqlstr);
