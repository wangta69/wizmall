...
if($action == 'idsearch'){
	...
	if($juminno1 && $juminno2){
		$result = $dbcon->_fetch_array($dbcon->_query( "select * from wizMembers where name='$name' AND Jumin1='$juminno1' AND Jumin2='$juminno2'")); 
	}else if($compno1 && $compno2){
		$result = $dbcon->_fetch_array($dbcon->_query( "select * from wizMembers where name='$name' AND Compnum = '$Compnum'")); 
	}
