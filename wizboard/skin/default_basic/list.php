...
<form NAME="board_search" action="<?=$PHP_SELF?>" mehtod="POST" onsubmit="return boardSearch(this)">
	...
	<div class="btn_box">
		<select maxlength="150" onBlur= "" name="search_term">
		...
		<input type="text" name="searchkeyword" size="20" value="<? echo $searchkeyword; ?>" checkenable msg="키워드를 입력하세요">
