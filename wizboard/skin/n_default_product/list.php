          ...
          <tr>
            <td bgcolor="F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr valign="bottom">
                  ...
                  <td align="center" class="font1">제품명</td>
                  <td width="2"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="2" height="15" /></td>
                  <td width="85" align="center" class="font1">규격</td>
                  <td width="2"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="2" height="15" /></td>
                  <td width="78" align="center" class="font1">옵션</td>
                  <td width="1"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="2" height="15" /></td>
				  <td width="78" align="center" class="font1">연식</td>
                  <td width="1"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="2" height="15" /></td>
				  <td width="78" align="center" class="font1">제작사</td>
                  <td width="1"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="2" height="15" /></td>
...
?>
          <tr>
            ...
            <td width="2">&nbsp;</td>
            <td align="left">&nbsp;<a href="<?=$PHP_SELF?>?getdata=<?=$getdata?>"><?=$list["SUBJECT"]?></a></td>
            <td width="2">&nbsp;</td>
            <td width="85" align="center"><?=$list["EMAIL"];?></td>
			<td width="2">&nbsp;</td>
            <td width="85" align="center"><?=$list["URL"];?></td>
            <td width="2">&nbsp;</td>
            <td width="85" align="center"><?=$list["SUB_TITLE1"];?></td>
			<td width="2">&nbsp;</td>
...
?>          
      <tr>
            <td height="26" colspan="13" align="center" >등록된글이없습니다</td>
          </tr>
          <tr bgcolor="E6E6E6">
            <td height="1" colspan="13"></td>
          </tr>
...
?>
          <tr>
            <td height="26" colspan="13" align="center"><table width="100%" height="26"  border="0" cellpadding="0" cellspacing="1" bgcolor="D7D7D7">
                <tr>
