...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td height="50" align="center"><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" bgcolor="#6393a1">
        <tr bgcolor="f0f0f0">
  ...
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="49" height="30" align="center" bgcolor="#F7F7F8">번호</td>
          ...
          <td align="center" bgcolor="#F7F7F8">제목</td>
          <td width="1" align="center" bgcolor="#F7F7F8"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/dotline.gif" width="1" height="25"></td>
          <td width="99" align="center" bgcolor="#F7F7F8">글쓴이</td>
          <td width="1" align="center" valign="middle" bgcolor="#F7F7F8"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images//dotline.gif" width="1" height="25"></td>
          <td width="109" align="center" bgcolor="#F7F7F8">작성일</td>
          <td width="1" align="center" valign="middle" bgcolor="#F7F7F8"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/dotline.gif" width="1" height="25"></td>
          <td width="70" align="center" bgcolor="#F7F7F8">조회수</td>
        </tr>
        <? 
...
?>
        <tr  height="1">
          <td height="1" colspan="9" align="center" bgcolor="#EBEBEB"></td>
        </tr>
        <tr>
          ...
          <td align="center" valign="middle"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/dotline.gif" width="1" height="25"></td>
          <td align="center"><?=date("Y/m/d", $list["W_DATE"])?></td>
          <td align="center" valign="middle"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/dotline.gif" width="1" height="25"></td>
...
?>
        ...
        <tr>
          <td height="30" colspan="9" align="center">로그인 하시면 질문에 대한 답변을 보실 수 있습니다.</td>
        </tr>
        <?
endif;
?>
        <tr  height="1">
          <td height="1" colspan="9" align="center" bgcolor="#E1E1E1"></td>
        </tr>
        <tr>
