...
?>              </td>
            ...
            <tr>
              <td width="99" height="30" align="center">writer</td>
              <td width="1" align="center" valign="middle" bgcolor="f0f0f0"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="1" height="25"></td>
              <td align="left">&nbsp;&nbsp;<input type="text" name="NAME" size="15" value="<? if($list["NAME"]) echo $list["NAME"]; else echo $cfg["member"]["mname"];?>" checkenable msg="pls. input your name" autocomplete="off" class="board_text" />              </td>
              <td width="1" align="center" valign="middle" bgcolor="f0f0f0"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="1" height="25"></td>
              <td width="99" align="center">password</td>
              <td width="1" align="center" valign="middle" bgcolor="f0f0f0"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="1" height="25"></td>
              <td align="left">&nbsp;&nbsp;<input type="password" name="PASSWD" size="15" value="<? echo $list["PASSWD"]; ?>" checkenable msg="pls. input password" autocomplete="off" class="board_text" /></td>
            </tr>
            <tr  height="1">
              <td height="1" colspan="7" align="center" bgcolor="#CCCCCC"></td>
            </tr>
...
<? endif; ?>
            ...
            <tr>
              <td height="180" colspan="7" align="center"><textarea name="CONTENTS" rows="15" id="CONTENTS" checkenable msg="pls. input comments" class="board_text"  style=" width:98%;" /><?=$list["CONTENTS"];?></textarea></td>
            </tr>
            <tr  height="1">
              <td height="1" colspan="7" align="center" bgcolor="#CCCCCC"></td>
            </tr>
