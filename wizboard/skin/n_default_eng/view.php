...
<div id="imgLayer" style="display:none;position:absolute;z-index:1000";>
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="right"><a href="javascript:closeImgLayer()">close[x]</a></td>
    </tr>
    <tr>
      ...
      <table width="100%" height="90" border="0" cellpadding="0" cellspacing="1" bgcolor="D7D7D7">
        <tr>
          <td bgcolor="#F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom">
                <td width="76" align="center" class="font1">writer</td>
        ...
        <tr>
          <td bgcolor="#F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom">
                <td width="75" align="center" class="font1">title</td>
                ...
                <td width="76" align="center"><span class="font1">attached</span></td>
