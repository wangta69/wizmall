...
<? endif; ?>
            ...
            <tr>
              <td width="99" height="30" align="center">이미지</td>
              <td width="1" align="center" valign="middle" bgcolor="f0f0f0"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="1" height="25"></td>
              <td colspan="5" align="left">&nbsp;&nbsp;
               
                <input type="file" name="file[0]" style="width:350px; border: 1px CCCCCC solid;background-color: #F7F7F7;font-family: '굴림';font-size: 12px;line-height: 18px;color: #333333;" />
                <? if($mode == "modify" && $list["filename"][0]) echo $common->getImgName($list["filename"][0])." <input name='file_del[0]' type='checkbox' value='1'>파일삭제"; ?></td>
            </tr>
            <tr  height="1">
              <td height="1" colspan="7" align="center" bgcolor="#CCCCCC"></td>
            </tr>
            ...
            <tr>
              <td width="99" height="30" align="center">동영상</td>
              <td width="1" align="center" valign="middle" bgcolor="f0f0f0"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="1" height="25"></td>
              <td colspan="5" align="left">&nbsp;&nbsp;
               
                <input type="file" name="file[1]" style="width:350px; border: 1px CCCCCC solid;background-color: #F7F7F7;font-family: '굴림';font-size: 12px;line-height: 18px;color: #333333;" />
                <? if($mode == "modify" && $list["filename"][1]) echo $common->getImgName($list["filename"][1])." <input name='file_del[1]' type='checkbox' value='1'>파일삭제"; ?></td>
            </tr>
            <tr  height="1">
              <td height="1" colspan="7" align="center" bgcolor="#CCCCCC"></td>
            </tr>
