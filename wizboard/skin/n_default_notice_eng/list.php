            ...
            <td width="270" align="center"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><select name="SEARCHTITLE" >
                      ...
                      <option value=""<? if($SEARCHTITLE == "" ) echo " selected";?>>All</option>
                      <option value="SUBJECT"<? if($SEARCHTITLE == "SUBJECT" ) echo " selected";?>>title</option>
                      <option value="CONTENTS"<? if($SEARCHTITLE == "CONTENTS" ) echo " selected";?>>contents</option>
                    </select></td>
        ...
        <tr>
          <td bgcolor="F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom">
                ...
                <td align="center" class="font1">title</td>
                <td width="2"><img src="./wizboard/skin/<?=$cfg["wizboard"]["BOARD_SKIN_TYPE"]?>/images/bar_1.gif" width="2" height="15" /></td>
...
?>
        <tr>
          <td height="26" colspan="7" align="center" >No lists</td>
        </tr>
        <tr bgcolor="E6E6E6">
          <td height="1" colspan="7"></td>
        </tr>
...
?>
        <tr>
          <td height="26" colspan="7" align="center"><table width="100%" height="26"  border="0" cellpadding="0" cellspacing="1" bgcolor="D7D7D7">
              <tr>
