...
$cfg["common"]["lan"] = "ks_c_5601-1987";//엑셀출력시 문자 셑
header("Content-Type: text/html; charset=".$cfg["common"]["lan"]);
}

if ($stitle && $keyword) {
                $whereis = "WHERE $stitle LIKE '%$keyword%'";
}
...
if($whereis) $whereis = "$WHEREIS AND RegDate >= '$FromDate' AND RegDate <= '$ToDate'";
else $WHEREIS = "WHERE RegDate >= '$FromDate' AND RegDate <= '$ToDate'";
}




$LIST_QUERY = "SELECT * FROM wizMembers $WHEREIS ORDER BY $sort DESC";
...
<table x:str9 style='border-collapse:
 ...
 <tr height=26 style='mso-height-source:userset;height:19.9pt'>
  <td height=26 class=xl2314925 width=38 style='height:19.9pt;width:29pt'>번호</td>
  <td class=xl2314925 width=88 style='border-left:none;width:66pt'>이름</td>
  <td class=xl2414925 width=88 style='width:66pt'>아이디</td>
  <td class=xl2414925 width=61 style='width:46pt'>성별</td>
  <td class=xl2314925 width=76 style='border-left:none;width:57pt'>나이</td>
  <td class=xl2314925 width=69 style='border-left:none;width:52pt'>가입일</td>
  <td class=xl2314925 width=69 style='border-left:none;width:52pt'>우편번호</td>
  <td class=xl2314925 width=280 style='border-left:none;width:210pt'>주소</td>
  <td class=xl2314925 width=126 style='border-left:none;width:95pt'>상세주소</td>
  <td class=xl2314925 width=84 style='border-left:none;width:63pt'>전화번호</td>
  <td class=xl23149250 style='border-left:none;width:68pt'>핸드폰번호</td>
  <td class=xl2314925 width=240 style='border-left:none;width:180pt'>이메일</td>
 </tr>
<?
...
?> 
 <tr height=32 style='mso-height-source:userset;height:24.0pt'>
  ...
  underline;text-underline-style:single;font-family:돋움, monospace;mso-font-charset:
