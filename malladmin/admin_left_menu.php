<table width="188" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="188" height="75" align='center' background="img/adminlogin_bg.gif"><table width="94%" border="0" cellspacing="5" cellpadding="0">
          <tr>
            <td height="50" colspan="2" align="center" bgcolor="A8E5A8" style="font-size:12px; color:#FFFFFF">관리자 님으로<br />
              접속중입니다.</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="275903"><table width="100" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
            ...
            <td ><a href="./admin_logout.php"><img src="img/adminlogin_icon03.gif" width="70" height="29" border="0"></a></td>
          </tr>
        </table></td>
    </tr>
  </table>
  <img src="img/adminS_title01.gif" width="187" height="70">
  <div id="menu0"> </div>
  <div id="menu1">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">기본환경</div>
  ...
  <div id="menu2">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">상품관리</div>
  ...
  <div id="menu3">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">매장관리</div>
  ...
  <div id="menu4">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">주문/배송관리</div>
  ...
  <div id="menu5">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">제휴업체관리</div>
  ...
  <div id="menu6">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">회원가입정보</div>
...
<div id="menu7">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">게시판관리</div>
...
?>                                  
 ...
 <li><A HREF="./main.php?menushow=menu7&theme=board/channel1"> 채널관리</a></li>                                
  ...
  <div id="menu8">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">방문자통계</div>
  ...
  <div id="menu9">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">매출/통계분석</div>
  ...
  <div id="menu10"> </div>
  <div id="menu11">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">메일발송</div>
  ...
  <div id="menu13">
    <div id="title"><img src="img/ba_icon01.gif" width="38" height="33">기타관리</div>
